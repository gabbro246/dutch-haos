(function initDutchI18n(root, factory) {
  ...
  const ru = {
    ...
    Bots: 'Боты', 'Choose bot...': 'Выберите бота…', 'Add bot': 'Добавить бота', Settings: 'Настройки', 'Show help': 'Показать справку',
    ...
    'A player': 'Игрок', 'Start peek: each player must look at exactly two own cards.': 'Начальный просмотр: каждый игрок должен посмотреть ровно две свои карты.',
    ...
    Take: 'Взять', empty: 'пусто', Peek: 'Смотр.', Swap: 'Обмен', 'Throw in': 'Сброс', Action: 'Действие',
