...
const INITIAL_DEAL_INTERVAL_MS = 120;
const INITIAL_DEAL_TRAVEL_MS = 240;
...
const HUMAN_THROW_IN_WINDOW_MS = 1000;
...
const DEFAULT_SERVER_CONFIG = Object.freeze({
  ...
  initialDealIntervalMs: INITIAL_DEAL_INTERVAL_MS,
  initialDealTravelMs: INITIAL_DEAL_TRAVEL_MS,
