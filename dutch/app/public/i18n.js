(function initDutchI18n(root, factory) {
  ...
  const de = {
    ...
    'Bot speed': 'Bot-Geschwindigkeit', Instant: 'Sofort', Fast: 'Schnell', Medium: 'Mittel', Normal: 'Normal', Slow: 'Langsam', 'Human-like': 'Menschenähnlich',
    'Choose how quickly bots take their turns. The throw-in window always lasts 1.0 seconds and is not affected by bot speed. This setting is shared by everyone.': 'Wähle, wie schnell Bots ihre Züge machen. Das Zeitfenster zum Einwerfen beträgt immer 1,0 Sekunden und wird von der Bot-Geschwindigkeit nicht beeinflusst. Diese Einstellung gilt für alle.',
    ...
    'Your move.': 'Du bist am Zug.', 'Your turn is complete. Say Dutch or click Next player.': 'Dein Zug ist beendet. Sage Dutch oder klicke auf „Nächster“.',
  ...
  const ru = {
    ...
    bot: 'бот', spectator: 'зритель', you: 'Вы', missing: 'нет на месте', Watching: 'Наблюдают',
    ...
    'Bot speed': 'Скорость ботов', Instant: 'Мгновенно', Fast: 'Быстро', Medium: 'Средне', Normal: 'Обычно', Slow: 'Медленно', 'Human-like': 'Как человек',
    'Choose how quickly bots take their turns. The throw-in window always lasts 1.0 seconds and is not affected by bot speed. This setting is shared by everyone.': 'Выберите, как быстро боты делают ходы. Окно для сброса всегда длится 1,0 секунды и не зависит от скорости ботов. Настройка общая для всех.',
    ...
    'Your move.': 'Ваш ход.', 'Your turn is complete. Say Dutch or click Next player.': 'Ваш ход завершён. Объявите Dutch или нажмите «Следующий».',
  ...
  function translateRussianGameText(input) {
    ...
    const botSpeedChange = value.match(/^(.+) changed bot speed from (Instant|Fast|Medium|Normal|Slow|Human-like) to (Instant|Fast|Medium|Normal|Slow|Human-like)$/i);
